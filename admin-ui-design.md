...
5. **通知・Webhook管理**: 全体通知設定・Webhook エンドポイント管理
6. **ログ・監視**: システムログ・パフォーマンス監視・エラー追跡
7. **バックアップ・復旧**: データバックアップ・システム復旧
...
6. **通知管理** (`/admin/notifications`) - 通知設定・Webhook管理
7. **ログ・監視** (`/admin/logs`) - システムログ・エラーログ・パフォーマンス
8. **バックアップ管理** (`/admin/backup`) - バックアップ作成・復旧
9. **設定インポート/エクスポート** (`/admin/config-transfer`) - 設定の一括管理
...
│  │                                                                         │ │
│  │ ┌─────────────┬─────────────┬─────────────┬─────────────┐                │ │
│  │ │ 🖥️ CPU使用率   │ 🧠 メモリ使用率  │ 🌐 API呼び出し   │ ⚠️ エラー件数     │                │ │
│  │ │     45%      │    62%     │   1,234/h  │     8       │                │ │
│  │ └─────────────┴─────────────┴─────────────┴─────────────┘                │ │
│  └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
